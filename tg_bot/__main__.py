...
TECHNO_IMG = "https://telegra.ph/file/42b9adaf0c3b4f5ce2adb.jpg"
IMPORTED = {}
MIGRATEABLE = []
HELPABLE = {}
STATS = []
...
def start(bot: Bot, update: Update, args: List[str]):
    if update.effective_chat.type == "private":
            ...
            update.effective_message.reply_photo(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="🤝HELP🤝",
                                                                       callback_data="help_back".format(bot.username)),
                                                                                   InlineKeyboardButton(text="😅MERA BHAGVAN😅",
                                                                       url="t.me/devilkali10")],
                                                                                   [InlineKeyboardButton(text="ADD DEVILKALI TO YOUR GROUP⚡",
        ...
        update.effective_message.reply_text("DEVILKALI IS ALWAYS ACTIVE!!")
